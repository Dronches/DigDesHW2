...
namespace WordCounter
{
    ...
    static class PathParser
    {
        ...
        public static string info = "Программа считает количество уникальных слов в заданном файле и записывает результат в файл.\n" +
            "Будьте внимательны, результат будет записан в ту же директорию c наименовнием " + PathParser.resultName + "!\n";
        ...
        public static string ConvertPath(string path)
        {
            ...
            return IsProgramDirection(path) ? ToProgramDirection(PathParser.resultName) : path.Substring(0, posEnd + 1) + PathParser.resultName;
        }
    }
}
